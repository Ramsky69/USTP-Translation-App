...
app.post('/api/translate', async (req, res) => {
 try {
  ...
  const prompt = `Translate the following text into ${target} and keep the tone natural. Return only the translation and make the ouput english readable for every language translated:\n\n${text}`;
